...
import os
import csv
os.environ["CUDA_VISIBLE_DEVICES"] = "4"  # SET the GPUs you want to use
import sys
...
model = AutoModelForSeq2SeqLM.from_pretrained(
    "models/mt0-xl", use_cache=True)
tokenizer = AutoTokenizer.from_pretrained("models/mt0-xl")
...
testFile = open('test_hindi2.csv', 'r')
...
for i in testList[1:]:
    ...
    # prompt = f"Input: I umm.. don't want to go uhh.. to the school. Remove disfluencies in the given sentence.\nOutput: I don't want to go to the school.\nInput: The sun sun rises in the east. Remove disfluencies in the given sentence.\nOutput: The sun rises in the east.\nInput: There are nin eight planets in the solar system. Remove disfluencies in the given sentence.\nOutput: There are eight planets in the solar system.\nInput: Let's meet at 2 sorry 3. Remove disfluencies in the given sentence.\nOutput: Let's meet at 3.\nInput: Ouch! It hurts.  Remove disfluencies in the given sentence.\nOutput: It hurts.\nInput: Well, I don't think I should try this. Remove disfluencies in the given sentence.\nOutput: I don't think I should try this.\nInput: Saketh and I drove I'm hungry now is there something to eat? Remove disfluencies in the given sentence.\nOutput: I'm hungry now is there something to eat?\nInput: I went to the market today. Remove disfluencies in the given sentence.\nOutput: I went to the market today.\nInput: {text_input} Remove disfluencies in the given sentence.\nOutput: "
    ...
    prompt_cs = (
    "Input: V svém krátkém životě jsem dělala už několik kurzů cizích jazyků na různých univerzitách nebo v jazykových školách. Correct grammatical or spelling errors in the given sentence.\nOutput: Ve svém krátkém životě jsem dělala už několik kurzů cizích jazyků na různých univerzitách nebo v jazykových školách.\n"
    "Input: Do Jemenu jsem jela s dvěma kamarádkami ze studií. Correct grammatical or spelling errors in the given sentence.\nOutput: Do Jemenu jsem jela se dvěma kamarádkami ze studií.\n"
    "Input: Strávily jsme měsíc v hlavním městě Jemenu – San'é , kde jsme se zúčastnily kurzu arabštiny. Correct grammatical or spelling errors in the given sentence.\nOutput: Strávily jsme měsíc v main městě Jemenu – San'á , kde jsme se zúčastnily kurzu arabštiny.\n"
    "Input: Musíme být úspěšní poprvé sámi. Correct grammatical or spelling errors in the given sentence.\nOutput: Musíme být úspěšní nejprve sami.\n"
    "Input: Co mi přinesl pobyt v Praze / na nějaké jiné zahraniční univerzitě? Correct grammatical or spelling errors in the given sentence.\nOutput: Co mi přinesl pobyt v Praze / na nějaké jiné zahraniční univerzitě?\n"
    f"Input: {text_input} Correct grammatical or spelling errors in the given sentence.\nOutput: "
    )

    prompt_cs_30p = (
    "Input: V svém short životě jsem dělala už několik kurzů cizích jazyků na různých univerzitách nebo v jazykových školách. Correct grammatical or spelling errors in the given sentence.\nOutput: Ve svém short životě jsem dělala už několik kurzů cizích jazyků na různých univerzitách nebo v jazykových školách.\n"
    "Input: Do Jemenu jsem jela s dvěma friends ze studies. Correct grammatical or spelling errors in the given sentence.\nOutput: Do Jemenu jsem jela se dvěma friends ze studies.\n"
    "Input: Spent jsme měsíc v main městě Jemenu – San'é , kde jsme se zúčastnily course arabic. Correct grammatical or spelling errors in the given sentence.\nOutput: Spent jsme měsíc v main městě Jemenu – San'á , kde jsme se zúčastnily course arabic.\n"
    "Input: have být úspěšní poprvé sámi. Correct grammatical or spelling errors in the given sentence.\nOutput: have být úspěšní nejprve sami.\n"
    # "Input: Co mi přinesl residence v Praze / na nějaké jiné zahraniční univerzitě? Correct grammatical or spelling errors in the given sentence.\nOutput: Co mi přinesl residence v Praze / na nějaké jiné zahraniční univerzitě?\n"
    f"Input: {text_input} Correct grammatical or spelling errors in the given sentence.\nOutput: "
    )

    prompt_cs_50p = (
    "Input: V svém short life jsem dělala already several kurzů cizích jazyků na různých univerzitách nebo v languages školách. Correct grammatical or spelling errors in the given sentence.\nOutput: Ve svém short life jsem dělala already several kurzů cizích jazyků na různých univerzitách nebo v languages školách.\n"
    "Input: Do Jemenu jsem going s dvěma friends ze studies. Correct grammatical or spelling errors in the given sentence.\nOutput: Do Jemenu jsem going se dvěma friends ze studies.\n"
    "Input: Spent jsme měsíc v main městě Jemenu – San'é , kde jsme se zúčastnily course arabic. Correct grammatical or spelling errors in the given sentence.\nOutput: Spent jsme měsíc v main městě Jemenu – San'á , kde jsme se zúčastnily course arabic.\n"
    "Input: have být úspěšní poprvé sámi. Correct grammatical or spelling errors in the given sentence.\nOutput: have být úspěšní nejprve sami.\n"
    # "Input: Co mi přinesl residence v Praze / na nějaké other foreign univerzitě? Correct grammatical or spelling errors in the given sentence.\nOutput: Co mi přinesl residence v Praze / na nějaké other foreign univerzitě?\n"
    f"Input: {text_input} Correct grammatical or spelling errors in the given sentence.\nOutput: "
    )

    prompt_cs_80p = (
    "Input: V svém short life jsem dělala already several courses foreign languages na různých univerzitách nebo v languages schools. Correct grammatical or spelling errors in the given sentence.\nOutput: Ve svém short life jsem dělala already several courses foreign languages na různých univerzitách nebo v languages schools.\n"
    "Input: Do Jemenu jsem going s dvěma friends ze studies. Correct grammatical or spelling errors in the given sentence.\nOutput: Do Jemenu jsem going se dvěma friends ze studies.\n"
    "Input: Spent jsme month v main městě Jemenu – San'é , kde jsme se zúčastnily course arabic. Correct grammatical or spelling errors in the given sentence.\nOutput: Spent jsme month v main městě Jemenu – San'á , kde jsme se zúčastnily course arabic.\n"
    "Input: have být succesful poprvé sámi. Correct grammatical or spelling errors in the given sentence.\nOutput: have být succesful nejprve sami.\n"
    # "Input: Co mi brought residence v Praze / na nějaké other foreign university? Correct grammatical or spelling errors in the given sentence.\nOutput: Co mi brought residence v Praze / na nějaké other foreign university?\n"
    f"Input: {text_input} Correct grammatical or spelling errors in the given sentence.\nOutput: "
    )
...
# filename = 'MT0_xl_results/result_g_80p.csv'
filename = f'MT0_xl_results/{sys.argv[2]}'
